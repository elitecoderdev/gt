...
public class ProcessValidarEmisor implements Processor {

	Logger log = Logger.getLogger(ProcessValidarEmisor.class);

	@Override
	public void process(Exchange exchange) throws Exception {
//		log.info("inicio processor");
//		log.info("-- body "+exchange.getIn().getBody());
 		Validacion val = new Validacion(TipoValidacion.EMISOR, true);
